...
// function CustomTooltip({ active, payload }: TooltipProps<TPSDataPoint>) {
...
//       <div>
//         <strong>Total TPS:</strong> {totalTPS.toLocaleString()}
//       </div>
//       <div>
//         True TPS: {dataPoint.truetps} | Vote TPS: {dataPoint.votetps}
//       </div>
//     </div>
//   )
// }
      ...
      <CardHeader>
        ...
        <div className="inline-flex rounded-md ml-auto" role="group">
            <button 
                ...
                className={`px-3 py-1 text-sm rounded-s-3xl transition-colors ${
                  range === "30m"
