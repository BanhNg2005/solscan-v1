...
export default function Body() {  
    return (  
        <div className="w-full flex-1 min-h ">  
            <div className="mx-auto max-w-full px-4 md:px-6 2xl:px-0 2xl:max-w-full md:flex items-center justify-between">  
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">  
                ...
                <div className="bg-white rounded-2xl border p-6 hover:shadow-lg transition-shadow">  
                    <div className="fkex gap-1 flex-row items-stretch justify-between flex-wrap w-full">  
                        <div className="flex items-center gap-3 mb-2">  
                            <h3 className=" text-gray-900">Total Stake (SOL)</h3>  
                        <Link href="/analysis/solana_staking" className="text-blue-500 font-roboto text-sm font-semibold leading-6 ml-auto">  
                        Skating Dashboard </Link>  
                        </div>  
                        <p className="text-neutral-800 font-roboto text-lg font-extrabold leading-6">400,924,311.34</p>  
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-5 px-4">
                ...
                {/* Right side - DeFi Charts (1/2 width on large screens) */}
